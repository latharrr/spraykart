  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 40px', width: '100%' }} className="hero-padding">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }} className="hero-grid">
            <div>
              ...
              <h1 className="hero-h1" style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(52px, 7vw, 96px)', fontWeight: 300, lineHeight: 1.02, color: '#ffffff', letterSpacing: '-0.02em', marginBottom: 32 }}>
            ...
            <div className="hero-stats" style={{ borderLeft: '1px solid rgba(255,255,255,.08)', paddingLeft: 80 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px 32px' }}>
                {[['10,000+','Happy Customers'],['500+','Luxury Fragrances'],['100%','Authenticity Guaranteed'],['2-Day','Express Delivery']].map(([num, label]) => (
                  <div key={label}>
                    <p style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 44, fontWeight: 300, color: '#ffffff', lineHeight: 1, marginBottom: 8, letterSpacing: '-0.02em' }}>{num}</p>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }} className="section-inner">
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 56, borderBottom: '1px solid #f0f0f0', paddingBottom: 28 }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 40, fontWeight: 400, letterSpacing: '-0.01em', color: '#0c0c0c', lineHeight: 1 }}>Featured Fragrances</h2>
            </div>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }} className="section-inner">
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 80, marginBottom: 64 }}>
            <div style={{ flexShrink: 0 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 40, fontWeight: 400, letterSpacing: '-0.01em', color: '#0c0c0c', lineHeight: 1 }}>The Spraykart<br />Promise</h2>
            </div>
      ...
      <section style={{ background: '#ffffff', padding: '96px 0' }} className="section-padding">
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }} className="section-inner">
          <div style={{ borderBottom: '1px solid #f0f0f0', paddingBottom: 28, marginBottom: 56 }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 40, fontWeight: 400, letterSpacing: '-0.01em', color: '#0c0c0c', lineHeight: 1 }}>Loved Across India</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, borderTop: '1px solid #eeeeee', borderLeft: '1px solid #eeeeee' }} className="testimonials-grid">
            {testimonials.map(({ name, city, text, rating }) => (
              <div key={name} style={{ padding: '40px 36px', borderRight: '1px solid #eeeeee', borderBottom: '1px solid #eeeeee' }}>
                ...
                <p style={{ fontSize: 15, color: '#3d3d3d', lineHeight: 1.75, marginBottom: 28, fontStyle: 'italic', fontFamily: "'Cormorant', Georgia, serif" }}>&ldquo;{text}&rdquo;</p>
      ...
      <section style={{ background: '#f9f9f7', borderTop: '1px solid #eeeeee', padding: '96px 0' }} className="section-padding">
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 40px' }} className="faq-inner">
          <div style={{ marginBottom: 56 }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 40, fontWeight: 400, letterSpacing: '-0.01em', color: '#0c0c0c', lineHeight: 1 }}>Common Questions</h2>
          </div>
          <div>
            {faqs.map(({ q, a }) => (
      ...
      <section style={{ background: '#0c0c0c', padding: '80px 40px', textAlign: 'center' }} className="cta-section">
        ...
        <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(36px, 5vw, 64px)', fontWeight: 300, color: '#ffffff', letterSpacing: '-0.02em', marginBottom: 40, lineHeight: 1.1 }}>
